...
public class TimeTableTM {
    ...
    public TimeTableTM(String sucode, int tblOrder, String subject, String year, String semester, String lecture, String date, String time, String latestUpdatedTime) {
        this.sucode = sucode;
